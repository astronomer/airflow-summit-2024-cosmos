...
if cosmos_version == "1.3.2":
    cosmos_dag13_dbt_ls_file = DbtDag(
        ...
        catchup=False,
        dag_id="cosmos_dag13_dbt_ls_file",
        tags=["cosmos_dag13"],
    )
else:
    logging.info(f"Skipping DAG cosmos_dag13_dbt_ls_file for cosmos version {cosmos_version}")
